...
**Bugs Fixed:** Startup failure classification, follow-up buffering, delayed attention return, upload cancellation, stale UI readiness, deployment sudo prompting, systemd template discovery, Studio's outdated bundled Codex runtime selection and stale speech movement ownership after playback acknowledgement.
