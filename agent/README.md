...
- `src/memory/`: delimited Markdown storage and keyword retrieval.
...
the repository. Retrieved memories are sent to Codex when used. No memory editor
or automatic memory collection is supplied in this slice.
