...
mod tests {
    ...
    use crate::devices::audio::{AudioCommand, RecordingAudioDevice, UnavailableAudioDevice};
    use crate::devices::driver::RuntimeDriver;
    use crate::devices::lighting::RecordingLightingDevice;
    ...
    impl RuntimeDriver for FollowingRuntimeDriver {
        ...
        fn joint_limits(&self) -> Result<Vec<crate::devices::driver::JointLimit>> {
            Ok(crate::ORION_JOINT_NAMES
                .iter()
                .map(|name| crate::devices::driver::JointLimit {
                    name: (*name).to_owned(),
                    lower_rad: -3.0,
                    upper_rad: 3.0,
                })
