...
- [Motion and animation architecture](../motion-and-animation-architecture.md):
  how character intent becomes continuous joint movement.
- [Trajectory and joint control](../trajectory-and-joint-control.md):
  exact compilation, runtime, and servo behavior.
